...
- Package root: /Users/rosscai/Documents/biomed-research-integrity-auditor/evals/cases/case_017
...
| --- | --- | --- | --- | --- |
| BIOMED-STAT-0001 | R2 | stats.consistency_check | Figure_10_precision_export.csv:treatment_a | Terminal-digit preference; weak triage signal |
| BIOMED-STAT-0002 | R2 | stats.consistency_check | Figure_10_precision_export.csv:treatment_b | Mixed numeric precision within one column; weak triage signal |
| BIOMED-STAT-0003 | R2 | stats.consistency_check | Figure_10_precision_export.csv:numeric_precision | Numeric precision differs systematically across columns; weak triage signal |
| BIOMED-STAT-0004 | R2 | stats.consistency_check | Figure_10_precision_export.csv:control<->treatment_a | Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal |
| BIOMED-STAT-0005 | R2 | stats.consistency_check | Figure_10_precision_export.csv:control<->treatment_b | Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal |
| BIOMED-STAT-0006 | R2 | stats.consistency_check | Figure_10_precision_export.csv:treatment_a<->treatment_b | Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal |
| BIOMED-STAT-0007 | R2 | stats.consistency_check | Figure_10_precision_export.csv:control<->treatment_a | Digit positions are preserved across paired columns |
...
- Location: Figure_10_precision_export.csv:treatment_a
- Finding Type: Terminal-digit preference; weak triage signal
- Evidence: `{"message": "Terminal-digit preference; weak triage signal", "evidence_type": "weak_forensic_triage_signal", "column": "treatment_a", "values_screened": 8, "effective_min_count": 8, "dominant_terminal_digit": "7", "dominant_share": 1.0, "digit_counts": {"7": 8}}`
...
- Risk Level: R2
- Module: stats.consistency_check
- Location: Figure_10_precision_export.csv:treatment_b
- Finding Type: Mixed numeric precision within one column; weak triage signal
- Evidence: `{"message": "Mixed numeric precision within one column; weak triage signal", "evidence_type": "weak_forensic_triage_signal", "column": "treatment_b", "values_screened": 8, "effective_min_count": 8, "decimal_place_counts": {"1": 4, "3": 4}}`
- Benign explanations considered: rounding, normalization, export, or reporting differences may explain the observation, source/raw records and analysis code are needed before escalation
- Required materials to resolve: source data, raw records where applicable, analysis file or code
- Recommended action: Inspect source data, analysis code, rounding, normalization, and benign explanations.
- Note: Calibrated from detector candidate; not a misconduct verdict.
...
- Risk Level: R2
- Module: stats.consistency_check
- Location: Figure_10_precision_export.csv:numeric_precision
- Finding Type: Numeric precision differs systematically across columns; weak triage signal
- Evidence: `{"message": "Numeric precision differs systematically across columns; weak triage signal", "evidence_type": "weak_forensic_triage_signal", "dominant_decimal_places_by_column": {"control": 1, "treatment_a": 3, "treatment_b": 1}, "decimal_place_counts_by_column": {"control": {"1": 8}, "treatment_a": {"3": 8}, "treatment_b": {"1": 4, "3": 4}}}`
- Benign explanations considered: rounding, normalization, export, or reporting differences may explain the observation, source/raw records and analysis code are needed before escalation
- Required materials to resolve: source data, raw records where applicable, analysis file or code
- Recommended action: Inspect source data, analysis code, rounding, normalization, and benign explanations.
- Note: Calibrated from detector candidate; not a misconduct verdict.
...
- Risk Level: R2
- Module: stats.consistency_check
- Location: Figure_10_precision_export.csv:control<->treatment_b
- Finding Type: Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal
- Evidence: `{"message": "Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal", "evidence_type": "weak_forensic_triage_signal", "left_column": "control", "right_column": "treatment_b", "paired_rows": 8, "slope": 1.0, "intercept": 0.4, "r2": 1.0, "max_abs_residual": 4.440892098500626e-16, "same_rank_order": true, "centered_residual_correlation": 1.0}`
- Benign explanations considered: rounding, normalization, export, or reporting differences may explain the observation, source/raw records and analysis code are needed before escalation
- Required materials to resolve: source data, raw records where applicable, analysis file or code
- Recommended action: Inspect source data, analysis code, rounding, normalization, and benign explanations.
- Note: Calibrated from detector candidate; not a misconduct verdict.
...
- Risk Level: R2
- Module: stats.consistency_check
- Location: Figure_10_precision_export.csv:treatment_a<->treatment_b
- Finding Type: Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal
- Evidence: `{"message": "Columns show whole-column additive/subtractive shift; weak-to-moderate triage signal", "evidence_type": "weak_forensic_triage_signal", "left_column": "treatment_a", "right_column": "treatment_b", "paired_rows": 8, "slope": 1.0, "intercept": 0.263, "r2": 1.0, "max_abs_residual": 2.220446049250313e-16, "same_rank_order": true, "centered_residual_correlation": 1.0}`
- Benign explanations considered: rounding, normalization, export, or reporting differences may explain the observation, source/raw records and analysis code are needed before escalation
- Required materials to resolve: source data, raw records where applicable, analysis file or code
- Recommended action: Inspect source data, analysis code, rounding, normalization, and benign explanations.
- Note: Calibrated from detector candidate; not a misconduct verdict.
...
- Evidence: `{"message": "Digit positions are preserved across paired columns", "evidence_type": "weak_forensic_triage_signal", "left_column": "control", "right_column": "treatment_a", "paired_rows": 8, "preserved_digit_positions": {"ones_digit": {"comparable_pairs": 8, "match_share": 1.0}}}`
- Benign explanations considered: rounding, normalization, export, or reporting differences may explain the observation, source/raw records and analysis code are needed before escalation
- Required materials to resolve: source data, raw records where applicable, analysis file or code
- Recommended action: Inspect source data, analysis code, rounding, normalization, and benign explanations.
- Note: Calibrated from detector candidate; not a misconduct verdict.
...
```json AUDIT_JSON_SUMMARY
{
  ...
  "materials_reviewed": [
    "PACKAGE_NOTE.txt",
    "manuscript.pdf",
    "source_data/Figure_10_precision_export.csv",
  ...
  "findings": [
    ...
    },
    {
      ...
      "risk_level": "R2",
      "finding_type": "Mixed numeric precision within one column; weak triage signal",
      "location": "Figure_10_precision_export.csv:treatment_b",
      "evidence_type": "weak_statistical_signal",
      "benign_explanations_considered": [
        "rounding, normalization, export, or reporting differences may explain the observation",
