...
- Package root: /Users/rosscai/Documents/biomed-research-integrity-auditor/evals/cases/case_025
...
| --- | --- | --- | --- | --- |
| TEXTOVERLAP-0001 | R2 | text.text_overlap_screen | lab_previous_papers/paper_a.txt#p001 / manuscript.pdf#p001 | methods_boilerplate_overlap |
...
- Location: lab_previous_papers/paper_a.txt#p001 / manuscript.pdf#p001
- Finding Type: methods_boilerplate_overlap
- Evidence: `{"document_a": "lab_previous_papers/paper_a.txt", "document_b": "manuscript.pdf", "section_a": "methods", "section_b": "methods", "paragraph_id_a": "lab_previous_papers/paper_a.txt#p001", "paragraph_id_b": "manuscript.pdf#p001", "similarity_score": 1.0, "overlapping_ngram_examples": ["according to the standard antibody", "after overnight attachment cultures were", "and imaged using identical microscope", "and maintained in dulbecco modified", "antibody protocol and imaged using"], "text_snippet_a": "Cells were seeded in six well plates and maintained in dulbecco modified eagle medium with ten percent fetal bovine serum. After overnight attachment, cultures were treated with vehicle or compound for twenty four hours, washed with phosphate buffered saline, fixed with paraformaldehyde, stained according to the standard antibody protocol, and imaged using i", "text_snippet_b": "Cells were seeded in six well plates and maintained in dulbecco modified eagle medium with ten percent fetal bovine serum. After overnight attachment, cultures were treated with vehicle or compound for twenty four hours, washed with phosphate buffered saline, fixed with paraformaldehyde, stained according to the standard antibody protocol, and imaged using i"}`
...
```json AUDIT_JSON_SUMMARY
{
  ...
  "materials_reviewed": [
    "PACKAGE_NOTE.txt",
    "lab_previous_papers/paper_a.txt",
    "manuscript.pdf"
  ],
  "materials_missing": [
    "ethics irb",
  ...
  "findings": [
    {
      ...
      "risk_level": "R2",
      "finding_type": "methods_boilerplate_overlap",
      "location": "lab_previous_papers/paper_a.txt#p001 / manuscript.pdf#p001",
      "evidence_type": "methods_boilerplate_overlap",
