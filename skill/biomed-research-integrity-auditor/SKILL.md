...
9. Assemble the report.
   ...
   - The action queue must group follow-up items as `must_resolve`, `provide_materials`, `clarify_or_disclose`, and `low_priority_checks`; each row should have owner/status tracker fields for team follow-up, and finding-derived rows should include copy-ready neutral inquiry and material-request text.
