...
5. Check numerical and statistical consistency.
   ...
   - Treat terminal-digit, Benford-style, p-value clustering, and small-variance patterns as weak triage signals.
...
- Weak triage signal: p-value clustering, terminal-digit pattern, unusually small SD, baseline balance, citation mismatch.
