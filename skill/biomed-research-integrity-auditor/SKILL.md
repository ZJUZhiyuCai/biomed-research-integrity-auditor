...
4. Screen image-integrity candidates.
   ...
   - State image-screening boundaries explicitly: current automated screens do not cover cross-paper image corpora, arbitrary-angle rotations, perspective/elastic deformation, substantial rescaling, splice forensics, JPEG ghosting, CFA/noise inconsistency, or lighting/shadow inconsistency.
